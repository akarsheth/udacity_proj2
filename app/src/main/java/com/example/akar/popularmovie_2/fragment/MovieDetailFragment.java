package com.example.akar.popularmovie_2.fragment;
...
import com.example.akar.popularmovie_2.adapter.Equal_Space;
import com.example.akar.popularmovie_2.adapter.Trailer_Adapter;
import com.example.akar.popularmovie_2.customviews.ReviewDialog;
import com.example.akar.popularmovie_2.data.Constants;
import com.example.akar.popularmovie_2.data.URLs;
import com.example.akar.popularmovie_2.data.MovieFavoritesColumns;
import com.example.akar.popularmovie_2.data.MovieProvider;
import com.example.akar.popularmovie_2.httphelper.JsonRequest;
import com.example.akar.popularmovie_2.httphelper.VolleyHelper;
import com.example.akar.popularmovie_2.model.Movie;
import com.example.akar.popularmovie_2.model.Trailer;
import com.example.akar.popularmovie_2.model.TrailerList;
...
public class MovieDetailFragment extends BaseFragment {
    ...
    private Trailer_Adapter trailerRecyclerAdapter;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (bundle != null)
        {
            mIsMultiPane = bundle.getBoolean(Constants.INTENT_KEY_IS_MULTIPANE);
        }
    ...
    protected void initView(Bundle savedInstanceState)
    {
        ...
        selectedMovie = getArguments().getParcelable(Constants.INTENT_KEY_MOVIE_DETAIL);
        ...
        trailerRecyclerAdapter = new Trailer_Adapter(mContext);
        ...
        if (selectedMovie != null)
        {
            ...
            {
                String url = URLs.MOVIE_DB_POSTER_BASE_URL + selectedMovie.getBackdropPath();
            ...
            recycleviewMovieTrailers.addItemDecoration(new Equal_Space(8));
    ...
    protected void setListeners() {
        ...
        trailerRecyclerAdapter.setOnItemClickedListener(new Trailer_Adapter.OnItemClickedListener() {
            @Override
        ...
        tvMovieReviews.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.isInternetAvailable(mContext))
                {
                    ...
                    bundle.putParcelable(Constants.INTENT_KEY_MOVIE_DETAIL, selectedMovie);
...
//                    getFragmentManager().beginTransaction().replace(R.id.detail_container, reviewsFragment).commit();
    ...
    private void fetchTrailers() {
        ...
        String url = URLs.MOVIE_DB_BASE_URL + String.format(URLs.MOVIE_DB_TRAILER_BASE_URL, selectedMovie.getId()) + URLs.MOVIE_PARA_API_KEY;
        if (Utils.isInternetAvailable(mContext))
        {
            mDialog.show();
            ...
            JsonRequest gsonRequest = new JsonRequest(url, TrailerList.class, null, new Response.Listener() {
                @Override
    ...
    private void playVideo(String youTubeKey) {
        String url = String.format(URLs.YOUTUBE_VIDEO_BASE_URL, youTubeKey);
