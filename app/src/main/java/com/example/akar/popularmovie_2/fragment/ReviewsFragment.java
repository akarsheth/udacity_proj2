...
import com.example.akar.popularmovie_2.adapter.RecyclerItemListener;
import com.example.akar.popularmovie_2.adapter.Reviews_Adapter;
...
import com.example.akar.popularmovie_2.model.Review;
import com.example.akar.popularmovie_2.model.ReviewList;
...
public class ReviewsFragment extends BaseFragment {
    ...
    private Reviews_Adapter reviewsRecyclerAdapter;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        reviewsRecyclerAdapter = new Reviews_Adapter(mContext);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(mContext, LinearLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.addItemDecoration(new Equal_Space(8));
    ...
    private void fetchData(final int page) {
        if (Utils.isInternetAvailable(mContext)) {
            ...
            String url = URLs.MOVIE_DB_BASE_URL + String.format(URLs.MOVIE_DB_REVIEWS_BASE_URL, selectedMovie.getId()) + URLs.MOVIE_PARA_API_KEY + URLs.PARA_PAGE + page;

            mDialog.show();
            Log.i(TAG, "Movie review URL: " + url);
            VolleyHelper volleyHelper = VolleyHelper.getInstance(mContext);

            JsonRequest<ReviewList> request = new JsonRequest<>(url, ReviewList.class, null, new Response.Listener<ReviewList>() {
                @Override
