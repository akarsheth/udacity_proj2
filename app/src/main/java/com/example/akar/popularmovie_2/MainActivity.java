package com.example.akar.popularmovie_2;
...
import com.example.akar.popularmovie_2.fragment.MovieDetailFragment;
import com.example.akar.popularmovie_2.fragment.MovieListFragment;
...
public class MainActivity extends AppCompatActivity implements MovieListFragment.MovieListCallback {
    ...
    public void onItemClickListener( int position, Movie movie) {
        ...
        bundle.putParcelable(Constants.INTENT_KEY_MOVIE_DETAIL, movie);
        bundle.putBoolean(Constants.INTENT_KEY_IS_MULTIPANE, isMultiPane);
